...
namespace KEngineConstants
{
    ...
    const unsigned int FLOAT_COUNT_PER_VERTEX = 9;
    ...
    const std::string MODEL_ASSET_DIR = "D:\\Dev\\KEngineX\\Assets\\Models\\";
    const std::string ASSET_DIR = "D:\\Dev\\KEngineX\\Assets\\Models\\";
    const std::string DEFAULT_TEXTURE_NAME = "KEngineDefaultTexture";
    const std::wstring SHADER_ASSET_DIR = L"D:\\Dev\\KEngineX\\Assets\\Shaders\\";
}
