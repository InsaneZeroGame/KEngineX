...
std::unique_ptr<gameplay::GamesScene> assetlib::LoadObj(const std::string & p_file_name)
{
    ...
    l_scene->m_main_camera.SetPerspectiveMatrix(45.0f * 3.1415f / 180.0f,600.0f/800.0f,5.5f, 15.0f);
    l_scene->m_main_camera.Update();

    //Setup Shadow Camera
    eye = Vector3(-8.0f, 15.0f, 5.0f);
    at = Vector3(0.0f, 0.0f, 0.0f);
    up = Vector3(0.0f, 1.0f, 0.0f);

    l_scene->m_shadow_camera.SetEyeAtUp(eye, at, up);
    l_scene->m_shadow_camera.SetPerspectiveMatrix(45.0f * 3.1415f / 180.0f, 600.0f / 800.0f, 5.5f, 55.0f);
