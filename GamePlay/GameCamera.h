...
namespace gameplay
{
    ...
    class GameCamera : public BaseCamera,public SceneNode
    {
    public:
        GameCamera(std::string p_name);
    ...
    inline GameCamera::GameCamera(std::string p_name) : m_ReverseZ(true),SceneNode(p_name)
    {
        SetPerspectiveMatrix( XM_PIDIV4, 9.0f / 16.0f, 1.0f, 1000.0f );
    }

    inline void GameCamera::SetPerspectiveMatrix( float verticalFovRadians, float aspectHeightOverWidth, float nearZClip, float farZClip )
    {
